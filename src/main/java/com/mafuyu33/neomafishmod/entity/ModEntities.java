...
public class ModEntities {
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES =
            DeferredRegister.create(Registries.ENTITY_TYPE, NeoMafishMod.MODID);

    public static final DeferredHolder<EntityType<?>, EntityType<TNTProjectileEntity>> TNT_PROJECTILE =
            ENTITY_TYPES.register("tnt_projectile",
                    () -> EntityType.Builder.<TNTProjectileEntity>of(TNTProjectileEntity::new, MobCategory.MISC)
                            .sized(0.25f, 0.25f)
                            .build(NeoMafishMod.id("tnt_projectile")));

    public static final DeferredHolder<EntityType<?>, EntityType<StoneBallProjectileEntity>> STONE_PROJECTILE =
            ENTITY_TYPES.register("stone_projectile",
                    () -> EntityType.Builder.<StoneBallProjectileEntity>of(StoneBallProjectileEntity::new, MobCategory.MISC)
                            .sized(0.25f, 0.25f)
                            .build(NeoMafishMod.id("stone_projectile")));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<LightningProjectileEntity>> LIGHTNING_PROJECTILE =
            ENTITY_TYPES.register("lightning_projectile",
                    () -> EntityType.Builder.<LightningProjectileEntity>of(LightningProjectileEntity::new, MobCategory.MISC)
                            .sized(0.25f, 0.25f)
                            .build(NeoMafishMod.id("lightning_projectile")));

    public static final DeferredHolder<EntityType<?>, EntityType<CustomWindChargeEntity>> CUSTOM_WIND_CHARGE =
            ENTITY_TYPES.register("custom_wind_charge",
                    () -> EntityType.Builder.<CustomWindChargeEntity>of(CustomWindChargeEntity::new, MobCategory.MISC)
                            .sized(0.3125F, 0.3125F)
                            .eyeHeight(0.0F)
                            .build(NeoMafishMod.id("custom_wind_charge")));
